...
/*    ifs.open("files_unpacked/ADV/6/0.bin");
    scanner.scanScript(ifs, "6");
    
    ifs.open("files_unpacked/ADV/10/0.bin");
    scanner.scanScript(ifs, "10"); */
